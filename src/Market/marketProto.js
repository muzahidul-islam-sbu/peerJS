...
exports.encodeCheckHoldersRequest = function (message) {
  var bb = popByteBuffer();
  _encodeCheckHoldersRequest(message, bb);
  return toUint8Array(bb);
}

function _encodeCheckHoldersRequest(message, bb) {
  // optional string fileHash = 1;
  var $fileHash = message.fileHash;
  if ($fileHash !== undefined) {
    writeVarint32(bb, 10);
    writeString(bb, $fileHash);
  }
};

exports.decodeCheckHoldersRequest = function (binary) {
  return _decodeCheckHoldersRequest(wrapByteBuffer(binary));
}

function _decodeCheckHoldersRequest(bb) {
  var message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string fileHash = 1;
      case 1: {
        message.fileHash = readString(bb, readVarint32(bb));
        break;
      }
...
exports.encodeRegisterFileRequest = function (message) {
  var bb = popByteBuffer();
  _encodeRegisterFileRequest(message, bb);
  return toUint8Array(bb);
}

function _encodeRegisterFileRequest(message, bb) {
...
exports.decodeRegisterFileRequest = function (binary) {
  return _decodeRegisterFileRequest(wrapByteBuffer(binary));
}

function _decodeRegisterFileRequest(bb) {
  var message = {};
...
exports.encodeHoldersResponse = function (message) {
  var bb = popByteBuffer();
  _encodeHoldersResponse(message, bb);
  return toUint8Array(bb);
}

function _encodeHoldersResponse(message, bb) {
  // repeated User holders = 1;
  var array$holders = message.holders;
  if (array$holders !== undefined) {
    for (var i = 0; i < array$holders.length; i++) {
      var value = array$holders[i];
      writeVarint32(bb, 10);
      var nested = popByteBuffer();
...
exports.decodeHoldersResponse = function (binary) {
  return _decodeHoldersResponse(wrapByteBuffer(binary));
}

function _decodeHoldersResponse(bb) {
  var message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        var limit = pushTemporaryLength(bb);
        var values = message.holders || (message.holders = []);
